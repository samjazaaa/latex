				...
				\begin{itemize}
					\item Bei Trauer
						\begin{itemize}
							...
							\item Strategien: Symptome bespr., Symptommentw. im Bezug zu Tod setzen, Beziehung 
								rekonstruieren, Abfolge und verbundene Emotionen beschreiben, auf andere Menschen 
								zugehen
						\end{itemize}
					\item Bei interpersonellen Konflikten und Auseinandersetzungen
						\begin{itemize}
							\item Ziele: Konflikte identifizieren, Handlungsplan, Erwartungen / Kommunikation ändern
							\item Strategien: Sympt., Sympt. Entw. im Bezug zu Konflikt mit Bezugsperson
							\item Stadium des Konflikts: Verhandlung, Sackgasse (Disharmonie erhöhen), Auflösung
							\item Verstehen nicht-reziproker Rollenerwartungen
							\item Parallelen zu anderen Beziehungen?
							\item Wie wird Konflikt aufrechterhalten?
						\end{itemize}
					\item Bei Rollenwechsel und -übergängen
						\begin{itemize}
							\item Ziele: Verlust der Rolle betrauern und akzeptieren, neue Rolle positiv sehen, Selbstwert 
								wieder herstellen
							\item Sympt., Bezug zu Bewältigung der Veränderung, pos / neg Aspekte der Rollen besprechen, 
								Gefühle bzgl. Verlust / Veränderung explorieren, Aufbau soz. Stützsystem
						\end{itemize}
					\item Bei interpersonellen Defiziten
						\begin{itemize}
							\item Ziele: Isolation verringern, neue Beziehungen unterstützen
							\item Strategien: Sympt., Bezug Depr. Isolation, wiederholende Beziehungsmuster explorieren, 
								pos / neg Aspekte früherer Beziehungen / Therapeut
						\end{itemize}
				\end{itemize}
			\item Endphase
				\begin{itemize}
					\item Abschiednehmen und Trauer
					\item Autonomie stärken
				\end{itemize}
